...
func ShowHelpMessage() {
	...
	fmt.Printf("%-50v Search provider for web search: exa (default), google, serpingapi or serply (Env: SEARCH_PROVIDER).\n%-50v Exa works without api key with rate limits and supports EXA_API_KEY env variable.\n%-50v google requires TGPT_GOOGLE_API_KEY and TGPT_GOOGLE_SEARCH_ENGINE_ID env variables.\n%-50v serpingapi requires SERPINGAPI_API_KEY env variable (free tier available).\n%-50v serply requires SERPLY_API_KEY env variable (free tier available).\n%-50s Check SEARCH_SETUP.md for google, serpingapi and serply: https://github.com/aandrew-me/tgpt/blob/main/SEARCH_SETUP.md\n", "--search-provider", "", "", "", "", "")
