...
func ShowHelpMessage() {
	...
	fmt.Printf("%-50v Enable built-in tool calling (all or comma-separated list: web_search, read_directory, read_file, execute_command, web_fetch, write_file)\n", "-t, --tools [tools]")
	...
	fmt.Println("web_search      Search the web for up-to-date information")
	...
	fmt.Println(`tgpt -t web_search,read_file "Search and read specified file"`)
