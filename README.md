...
tgpt is a cross-platform command-line interface (CLI) tool that allows you to use ChatGPT 3.5 in your Terminal without requiring API keys. Thanks to [Chatgptlogin.ai](https://chatgptlogin.ai/chat/) for API.
